...
const donorsData = [
  { id: 1, name: 'John Smith', bloodGroup: 'A+', city: 'New York', status: 'Available' },
  { id: 2, name: 'Sarah Johnson', bloodGroup: 'O+', city: 'Los Angeles', status: 'Available' },
  { id: 3, name: 'Michael Brown', bloodGroup: 'B+', city: 'Chicago', status: 'Unavailable' },
  { id: 4, name: 'Emily Davis', bloodGroup: 'AB+', city: 'Houston', status: 'Available' },
  { id: 5, name: 'David Wilson', bloodGroup: 'A-', city: 'Phoenix', status: 'Available' },
  { id: 6, name: 'Jennifer Garcia', bloodGroup: 'O-', city: 'Philadelphia', status: 'Unavailable' },
  { id: 7, name: 'Robert Martinez', bloodGroup: 'B-', city: 'San Antonio', status: 'Available' },
  { id: 8, name: 'Lisa Anderson', bloodGroup: 'AB-', city: 'San Diego', status: 'Available' },
];
                ...
                <td className="py-4 px-4">
                  ...
                  `}>
                    <span className={`w-2 h-2 rounded-full mr-2 ${
                      donor.status === 'Available' ? 'bg-green-500' : 'bg-red-500'
                    }`} />
                    {donor.status}
                  </span>
                </td>
